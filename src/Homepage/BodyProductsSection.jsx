...
const BodyProductsSection = () => {
    const Body_Products_REF = useRef(null);
          ...
          useEffect(() => {
            ...
            const handleScroll = () => {
              ...
              if (!Body_Products_REF.current) return;
        
              const topPosition =
                Body_Products_REF.current.getBoundingClientRect().top;
  ...
  return (
    <div
              ref={Body_Products_REF}
              className={`FemaleClothes sticky top-0 -mt-[100px] bg-gradient-to-b from-[#0E5990] to-[#2b353c] h-screen w-full flex flex-col relative z-51 transition-all duration-300
...
export default BodyProductsSection