...
const BodyProductsSection = () => {
  ...
  return (
    <div
              ...
              className={`FemaleClothes sticky top-0 -mt-[80px] bg-gradient-to-b from-[#0E5990] to-[#2b353c] h-screen w-full flex flex-col relative z-51 transition-all duration-300
