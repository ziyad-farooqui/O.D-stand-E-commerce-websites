...
const MaleClothesSection = () => {

    const MALE_CLOTHES_REF = useRef(null);
      ...
      useEffect(() => {
        ...
        const handleScroll = () => {
          ...
          if (!MALE_CLOTHES_REF.current) return;
    
          const topPosition =
            MALE_CLOTHES_REF.current.getBoundingClientRect().top;
  ...
  return (
     <div
          ref={MALE_CLOTHES_REF}
          className={`FemaleClothes sticky top-0 -mt-[100px] bg-gradient-to-b from-[#227EB3] to-[#2b353c] h-screen w-full flex flex-col relative z-51 transition-all duration-300
...
export default MaleClothesSection