        ...
        const OFFER_SECTION_REF = useRef(null);
              const [isAtTop, setIsAtTop] = useState(false);
                ...
                useEffect(() => {
                  ...
                  const handleScroll = () => {
                    ...
                    if (!OFFER_SECTION_REF.current) return;
              
                    const topPosition =
                     OFFER_SECTION_REF.current.getBoundingClientRect().top;
          ...
          return (
            ...
            <div className="theitem flex-shrink-0 border border- bg-[#BDC6CE] h-55 w-72 max-w-80 md:max-w-80 rounded-2xl p-1 flex flex-col gap- items-center mb-70">
              ...
              <div className=" bg-[#7D6AFF] border- w-full h-[52%] rounded-2xl">
              </div>
      
      
              {/* Niche wala box */}
      
              <div className="  w-full h-[35%] rounded-b-2xl">
      
                <div className=" bg-[#EEEEEE] h-8 w-full mt-1 rounded-2xl">
      
                  <h1 className="text-[20px] pl-2 uppercase font-bold">
                    Item Title
                  </h1>
                ...
                {/* <div className=" bg-[#EEEEEE] text-[15px] h-5 w-full mt-1 rounded-2xl text-center justify-center items-center flex">
                ...
                <div className=" bg-[#EEEEEE] h-15 w-full mt-1 rounded-2xl">
      
                  <p className="text-[15px] pl-2">
                    Item Description
                  </p>
             ...
             >
              ...
              {/*the button for */}
               <button
                 ...
                 className="nextbuttonleft mb-10 shadow-lg border-2  border-white/20 bg-white/10 backdrop-blur-md h-9 w-9 md:h-12 md:w-12 flex absolute z-90 bottom-[50%] left-2 md:left-5 rounded-full text-center justify-center items-center text-[30px] rotate-180 cursor-pointer active:scale-95 transition-transform"
               >
                 <GrFormNext />
               </button>
               ...
               <button
                 ...
                 className="nextbuttonright mb-10 shadow-lg border-2  border-white/20 bg-white/10 backdrop-blur-md h-9 w-9 md:h-12 md:w-12 flex absolute z-90 bottom-[50%] right-2 md:right-5 rounded-full text-center justify-center items-center text-[30px] cursor-pointer active:scale-95 transition-transform"
               >
                 <GrFormNext />
               </button>
