...
const FemaleClothesSection = () => {
  ...
  return (
    ...
    <div
      ...
      className={`FemaleClothes sticky top-0 -mt-[100px] bg-gradient-to-b from-[#6AB8E0] to-[#2b353c] h-screen w-full flex flex-col relative z-51 transition-all duration-300
